...
export default function App() {
  ...
  return (
    <div style={{display:"flex",height:"100vh",fontFamily:"'Times New Roman',serif",background:"#1a1f2e",overflow:"hidden"}}>
      <style>{`
        ::-webkit-scrollbar{width:5px}::-webkit-scrollbar-thumb{background:#3a4a6a;border-radius:3px}
        .sb{width:100%;text-align:left;border:none;cursor:pointer;padding:9px 14px;border-radius:5px;transition:all 0.12s;background:transparent;font-family:inherit;}
        .sb:hover{background:rgba(100,160,255,0.1)}.sb.on{background:rgba(100,160,255,0.2);border-left:3px solid #64a0ff}
        .sb.ex.on{background:rgba(246,173,85,0.15);border-left:3px solid #f6ad55}
        .ab{background:#e8f5e9;color:#2e7d32;border:1.5px dashed #2e7d32;font-size:10px;padding:2px 9px;border-radius:3px;cursor:pointer;margin-top:4px;font-family:Arial,sans-serif}
        .rb{background:none;color:#e57373;border:none;cursor:pointer;padding:0 4px;font-size:13px;flex-shrink:0}
        .toast{position:fixed;bottom:18px;left:50%;transform:translateX(-50%);padding:10px 22px;border-radius:6px;font-family:Arial,sans-serif;font-size:12px;font-weight:600;z-index:9999;background:#1565c0;color:#fff;box-shadow:0 4px 14px rgba(0,0,0,.35);white-space:nowrap}
        .wl{font-family:Arial,sans-serif;font-size:9px;font-weight:700;color:#64a0ff;letter-spacing:1.5px;text-transform:uppercase;padding:10px 14px 3px;opacity:.75}
      `}</style>
